...
# Dataset
The full RateAR dataset will be available for download by November 2026, if not sooner. The dataset follows the hierarchical file structure shown below:
```
dataset
└───rateAR_images
...
<p align="center"><img width="600" alt="Representative cropped examples from the RateAR dataset illustrating various quality levels across three visual features of interest." src="https://github.com/AResearcherOfThings/RateAR/blob/main/RateAR_samples.png"></p>
